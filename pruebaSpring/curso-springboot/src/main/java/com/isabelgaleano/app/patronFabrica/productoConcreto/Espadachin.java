...
public class Espadachin extends Personaje {
    ...
    public Espadachin(int id, int precio, int vida, int cantMovimientos, int defensa, Ataque ataque, int cantOro, int maxOro, String estado, PowerUp powerUp, String tipo, boolean estadoDecorado, int idCasilla) {
